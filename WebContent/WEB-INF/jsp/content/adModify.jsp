...
<input type="hidden" name="basepath" value="${basepath}"  />
		<form id="mainForm" method="post" action="changeAd?id=${ad.id}" enctype="multipart/form-data">
				...
				<div class="rightCont">
					...
					<table class="tab1" width="100%">
						<tbody>
							...
							<td width="30%">
								<a href="${ad.imageUrl}" id="chakan">查看图片</a>
						...
						<tr>
							...
							<td width="30%">
								<input id="weight" name="weight"  value="${ad.weight}" class="allInput" style="width:100%;" type="text"/>
							</td>
						</tr>
					  </tbody>
					</table>
					<div style="text-align: center; margin-top: 30px;">
						...
						<input class="tabSub" value="返     回" type="button" onclick="location.href='${basepath}/backAd'"/>
					</div>
				</div>
			</div>
		</form>
