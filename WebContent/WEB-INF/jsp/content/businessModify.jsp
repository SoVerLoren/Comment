			...
			<div class="right">
				...
				<div class="rightCont">
							...
							<tr>
								...
								<td width="30%">
									<select name="city">
											...
											<option value="">大冶</option>
											<option value="">阳新</option>
									</select>
								</td>
								<td align="right" width="10%">类别<font color="red">*</font>：</td>
								<td width="30%">
									<select name="category">
										<option value="" selected="selected">美食</option>
										<option value="">旅游</option>
										<option value="">婚纱</option>
									</select>
								</td>
							</tr>
							<tr>
					...
					<div style="text-align: center; margin-top: 30px;">
						...
						<input class="tabSub" value="返     回" type="button" onclick="location.href='${basepath}/backBu'"/>
					</div>
				</div>
			</div>
		</form>
