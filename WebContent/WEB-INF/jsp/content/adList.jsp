...
<input type="hidden" name="basepath" value="${basepath}"  />
		<form action="selectAd" id="mainForm" method="post">
							...
							<tr>
	                            ...
	                            <td style="text-align: right;" width="150">
	                            	...
	                            	<t:auth url="/ad/addInit">
	                            		<input class="tabSub" value="添加" onclick="location.href='${basepath}/addAd'" type="button"/>
	                            	</t:auth>
	                            </td>
	       					</tr>
						</tbody>
							...
							<c:forEach items="${adPageList.list}" var="ad">
									<tr>
										...
										<td>
											...
											<a href="javascript:void(0);" onclick="location.href='${basepath}/modifyAd?id=${ad.id}&imgFileName=${ad.imgFileName}'">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;
										
										
											<a href="javascript:void(0);" onclick="location.href='${basepath}/delAd?id=${ad.id}'">删除</a>
...
<div class="page fix">
	...
	当前第<span class="yeshu">${adPageList.pageNum}</span>/<span class="zongyeshu">${adPageList.pages}</span>页
